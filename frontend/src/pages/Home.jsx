...
export default function Home() {
  ...
  const categories = categoriesData?.success ? categoriesData.data.map(category => ({
    name: category,
      ...
      <section className="container mx-auto px-2 sm:px-4 py-8 sm:py-12 lg:py-16">
        ...
        {categoriesLoading ? (
          ...
          <motion.div 
            ...
            initial="hidden"
            animate="visible"
            className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-2 sm:gap-4"
          >
      ...
      <section className="container mx-auto px-2 sm:px-4 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 text-primary-600 dark:text-primary-400 mb-3 sm:mb-4">
                {feature.icon}
              </div>
